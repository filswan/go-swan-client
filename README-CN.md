...
-   在 [Swan Platform](https://console.filswan.com/#/dashboard) 上创建任务和离线订单
    ...
    **(存储供应商可以通过 [Swan Provider](https://github.com/filswan/go-swan-provider/tree/release-2.6.0) 自动导入订单)**
...
```
<font color="red"> **Note：** </font>如果您使用的是 `market_version = "1.2"`, 请确保存储提供商使用的 `swan-provider` 版本为 [v2.6.0](https://github.com/filswan/go-swan-provider/releases/tag/v2.6.0) 及以上。
