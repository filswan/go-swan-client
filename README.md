...
<img src="http://yuml.me/diagram/plain/activity/(start)->(Genrate Car Files Using Lotus)->|A|,(start)->(Genrate Car Files Using Graphsplit)->|A|->(Upload Car Files)-><public_deal=true&bid_mode=0>(Create Public Manual-Bid Task)->(Send Deal)->(end)" >
